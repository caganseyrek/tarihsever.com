...
import { ArticleFileProps, Loader, TopicFileProps } from "@/shared/lib/file-manager";
import tokenize from "@/shared/lib/search/tokenizer";
...
class Indexer {
  ...
  public static init(): void {
    const topics: TopicFileProps[] = Loader.loadAll("topics");
    const articles: Omit<ArticleFileProps, "topic">[] = Loader.loadAll("articles");
