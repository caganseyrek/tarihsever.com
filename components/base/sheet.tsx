...
type SheetContentProps = React.ComponentProps<typeof Content> & VariantProps<typeof sheetVariants>;
...
const SheetClose = ({ className, ...props }: React.ComponentProps<typeof Close>) => (
  <Close
    className={cn(
...
const SheetOverlay = ({ className, ...props }: React.ComponentProps<typeof Overlay>) => (
  <Overlay
    className={cn(
...
const SheetTitle = ({ className, ...props }: React.ComponentProps<typeof Title>) => (
  <Title className={cn("w-full flex flex-row items-center justify-start gap-2", className)} {...props} />
);

const SheetDescription = ({ className, ...props }: React.ComponentProps<typeof Description>) => (
  <Description className={cn("w-full flex flex-row items-center justify-start gap-2", className)} {...props} />
);
